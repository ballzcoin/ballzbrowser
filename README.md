...
BallzBrowser is the tool of choice to browse and use Ðapps on the Ballzcoin network. BallzBrowser is based on [Mist](https://github.com/ethereum/mist), the Ethereum Ðapp browser.

For the Mist API see the [MISTAPI.md](MISTAPI.md).

#### Please note that this repository is the Electron host for the Meteor based wallet dapp whose repository is located here: https://github.com/ballzcoin/ballzwallet-dapp-wallet. The remainder of this document is included for reference only at this stage, primarily for those who want to build the Ballzcoin wallet from source. The contents are unchanged from the original Mist / Ethereum repository. The instructions for building still apply to BallzBrowser. 
...
Start the wallet app for development, *in a separate terminal window:*
    ...
    $ cd my/path/ballzwallet-dapp-wallet/app && meteor --port 3050
...
To generate the Ethereum Wallet (this will pack the one Ðapp from https://github.com/ethereum/ballzwallet-dapp-wallet):
...
- `master`
- `develop`
- `local` Will try to build the wallet from [mist/]../ballzwallet-dapp-wallet/app
