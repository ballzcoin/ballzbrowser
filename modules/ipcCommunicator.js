            ...
            */
            ...
            if (type === 'ethersale') {
                ...
                // geth
                    ...
                    if (process.platform === 'darwin') keystorePath += '/Library/Ballzcoin/keystore';

                    if (process.platform === 'freebsd' ||
                        process.platform === 'linux' ||
                        process.platform === 'sunos') keystorePath += '/.ballzcoin/keystore';

                    if (process.platform === 'win32') keystorePath = `${Settings.appDataPath}\\Ballzcoin\\keystore`;
                }
...
ipc.on('backendAction_importWalletFile', (e, path, pw) => {
    ...
    const binPath = ClientBinaryManager.getClient('ballzcoin').binPath; // was geth
