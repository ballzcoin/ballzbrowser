...
const BINARY_URL = 'https://raw.githubusercontent.com/ballzcoin/ballsbrowser/master/clientBinaries.json';
...
//        const nodeType = 'Geth';
        ...
        .then((localConfig) => {
            ...
            return mgr.init({
                folders: [
                    path.join(Settings.userDataPath, 'binaries', 'ballzcoin', 'unpacked'),
