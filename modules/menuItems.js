...
let menuTempl = function (webviews) {
                ...
                submenu: [
                    {
                        ...
                        click() {
                            ...
                            // geth
                                ...
                                if (process.platform === 'darwin') {
                                    userPath += '/Library/Ballzcoin/keystore';
                                }

                                if (process.platform === 'freebsd' ||
                                process.platform === 'linux' ||
                                process.platform === 'sunos') {
                                    userPath += '/.ballzcoin/keystore';
                                }

                                if (process.platform === 'win32') {
                                    userPath = `${Settings.appDataPath}\\Ballzcoin\\keystore`;
                                }
                            }
    ...
    helpMenu.push({
        ...
        click() {
            shell.openExternal('https://github.com/ballzcoin/ballzbrowser/wiki');
        },
    }, {
        label: i18n.t('mist.applicationMenu.help.reportBug'),
        click() {
            shell.openExternal('https://github.com/ballzcoin/ballzbrowser/issues');
        },
    });
