...
class Settings {
    ...
    get appName() {
        return this.uiMode === 'mist' ? 'Mist' : 'Ballzcoin Ballzbrowser Wallet';
    }
    ...
    get rpcIpcPath() {
        ...
        if (process.platform === 'darwin') {
            ipcPath += '/Library/Ballzcoin/ballzcoin.ipc';
        } else if (process.platform === 'freebsd' ||
       process.platform === 'linux' ||
       process.platform === 'sunos') {
//            ipcPath += '/.ethereum/geth.ipc';
            ipcPath += '/.ballzcoin/ballzcoin.ipc';
        } else if (process.platform === 'win32') {
            ipcPath = '\\\\.\\pipe\\ballzcoin.ipc';
        }
