...
!define GROUPNAME "Ballzcoin"
!define HELPURL "https://github.com/ballzcoin/ballzbrowser/releases/issues"
!define UPDATEURL "https://github.com/ballzcoin/ballzbrowser/releases"
!define ABOUTURL "https://ballzcoin.org"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\Ballzcoin"
...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Geth incoming peers (TCP:31805)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Ethereum" 31805 "" "" ""
    #SimpleFC::AdvAddRule "Geth outgoing peers (TCP:31805)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Ethereum" "" 31805 "" ""
    #SimpleFC::AdvAddRule "Geth UDP discovery (UDP:31805)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Ethereum" "" 31805 "" ""
...
Section "uninstall"
    ...
    #SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:31805)"
    #SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:31805)"
    #SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:31805)"
